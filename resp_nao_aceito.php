    ...
    <section id="container">
      ...
      <section class="content-registro">
          <div class="informacao">
            <h1 style="font-size:25pt; text-align: center;">Mensagem não enviada!</h1><br/>
            <hr>

                <p style="font-size: 15pt; margin: 30px 0;">Por algum motivo, seu cadastro não foi enviado. Volte e preencha
                de forma acertiva e valide seus dados.</p>
